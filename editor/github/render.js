...
function updateOutput(skipPreviewUpdate = false) {
    ...
    if (hasBgm) {
        innerContent += `
<iframe id="bgmPlayerFrame" src="data:text/html;charset=utf-8,${encodeURIComponent(BGM_PLAYER_TEMPLATE)}" style="position: fixed; bottom: 20px; right: 20px; width: 32px; height: 32px; border: none; z-index: 9999; background: transparent; transition: 0.3s;" allow="autoplay"></iframe>
<script>
